// Production server for the built SPA. Vite build emits static client assets
// to dist/ (index.html + assets). This wraps them in a Bun server on port 3000
...
console.log(`FirstCommit site serving on http://${HOST}:${String(PORT)}`);
